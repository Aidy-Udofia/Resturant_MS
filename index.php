        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="imagesfood-mania-logo.png" alt="">Online Resturant</a>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p> Oliver Tweest Ikot Ekpene <br> #5 Aba road, Ikot Ekpene, Akwa-Ibom, Nigeria</p>
